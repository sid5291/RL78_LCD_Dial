...
extern void FBG_Test(void);
extern void LCDDrawLine(PointT*, PointT*, uint8_t);
extern void LCDDrawDialBackground(void);
extern void TestMyCode(void);
/* End user code. Do not edit comment generated here */
...
void main(void)
{
    ...
    LCDFont(FONT_LARGE);
    LCDString("Project 3", 0, 0);
    LCDString("skumar15", 0, 8);

	for (volatile uint32_t n=0; n<3000000; n++)
		;
      LCDClearScreen();
	...
	Init_Profiling();
  	Enable_Profiling();
	TestMyCode();           // Put your code to profile here
	Disable_Profiling();
